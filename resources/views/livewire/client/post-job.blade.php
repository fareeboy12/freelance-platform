  ...
  <div>
    ...
    <div class="rounded border w-full p-4 mt-10 bg-white">
        ...
        <div>
                ...
                <div class="w-full px-4 py-4">
                  ...
                  <div class="flex flex-row gap-4">
                    <div class="flex items-center">
                      <input required type="radio" wire:model="job_type" name="job_type" id="short_term" value="short_term" class="w-4 h-4 text-gray-600 bg-gray-100 border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600" />
                      <label for="short_term" class="ml-2 text-sm font-medium text-gray-900">Short term or part time work</label>
                    </div>
                    <div class="flex items-center">
                      <input required type="radio" name="job_type" wire:model="job_type" id="longer_term" value="longer_term" class="w-4 h-4 text-gray-600 bg-gray-100 border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600" />
                      <label for="longer_term" class="ml-2 text-sm font-medium text-gray-900">Longer term work</label>
                    </div>
                  </div>
                </div>
            </div>
            ...
            <input required type="text" wire:model="title" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"/>
            ...
            <div class="flex items-center mb-4">
                <input required id="large" wire:model="scope" type="radio" value="large" name="scope" class="w-4 h-4 text-gray-600 bg-gray-100 border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
            ...
            <div class="flex items-center mb-4">
                <input required id="medium" wire:model="scope" type="radio" value="medium" name="scope" class="w-4 h-4 text-gray-600 bg-gray-100 border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
            ...
            <div class="flex items-center">
                <input required id="small" wire:model="scope" type="radio" value="small" name="scope" class="w-4 h-4 text-gray-600 bg-gray-100 border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
            ...
            <button wire:click="postAJob" class="rounded-full bg-blue-300 hover:bg-blue-500 text-white py-2 px-6 mt-10">Publish Job</button>
        </div>
    </div>
</div>
